...
Desde a década de 90, jogos digitais se tornaram uma \textquotedbl forma dominante
de recriação\textquotedbl{} \textsc{\autocite{gameDesignPatterns}}. Devido a fatores
...
ferramentas científicas e de negócios, tornando-se plataformas de
diversão. Atualmente jogos são utilizados em uma vasta gama de
dispositivos \textsc{\autocite[p. 6]{crossPlatformMobileGameDevelopment}}.
...
a múltiplas plataformas que o HTML provê \textsc{\autocite{html5Tradeoffs}}.
...
jogos utilizando as tecnologias da Web \textsc{\autocite{html5mostwanted}}.
Desenvolvedores de sites podem reaproveitar o conhecimento
direcionando-o para o desenvolvimento de jogos. O interesse por
parte dos desenvolvedores também é grande, \citet{htmlSurvey}
...
67\% menor que aplicações nativas \textsc{\autocite[p. 460]{html5Tradeoffs}}.

Contudo, apesar da utilização da Web ser gigantesca, criar
...
aos jogos que sofrem ou são comummente ligados a
