...
namespace DoctrineORMModule\Proxy\__CG__\Core\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class City extends \Core\Model\City implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'state', 'zipCodeCollection', 'created', 'updated', 'inputFilter');
        }
     ...
     * {@inheritDoc}
     */
    public function getZipCodeCollection()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getZipCodeCollection', array());

        return parent::getZipCodeCollection();
    }
