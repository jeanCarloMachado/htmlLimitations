 ...
 */
class Tour extends \Application\Model\Tour implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'frontendService', 'tourUserCollection', 'id', 'created', 'updated', 'inputFilter');
        }
     ...
     * {@inheritDoc}
     */
    public function setFrontendService($frontendService)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFrontendService', array($frontendService));

        return parent::setFrontendService($frontendService);
    }
    ...
    public function getFrontendService()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFrontendService', array());

        return parent::getFrontendService();
    }
