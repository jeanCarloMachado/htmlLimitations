...
responsabilidades do programador. jQuery mobile sofre com problemas de
performance em ambientes móveis, em partes por não utilizar aceleração de hardware
para criar suas interfaces, como fazem alguns concorrentes como o Sencha Touch\autocite[pp. 14]{viabilityBusinessApplications}.
...
que fornece um conjunto de componentes para criação de interfaces
gráficas para dispositivos móveis similares as nativas. O projeto é
similar ao jQuery mobile por focar-se apenas na interface e relegar
outros aspectos a ferramentas integradas como o PhoneGap.
Com o Sencha Touch desenvolve-se em JavaScript e nas demais tecnologias
da WEB e cria-se binários para Android, IOS, Windows Phone, Tizen, etc.
