...
são geralmente de mente aberta e criaram uma variedade de
...
Enchant.js, dentre suas funcionalidades constam: orientação à objetos,
orientado à eventos, contém um motor de animação, suporta WebGL
e Canvas, et.c 


three.js: considerada leve, renderiza, WebGL e Canvas,
...
É um editor na nuvem focado para usuários sem
...
\textit{drag-and-drop} (Intel XDK) e bibliotecas para a construção de
jogos utilizando aceleração de hardware, o que garante até duas vezes
mais performance que aplicativos mobile baseados em Web tradicionais.
