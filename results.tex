...
Não obstante, algumas limitaçãos como performance e versões foram tratadas 
em uma partes separadas visto que se aplicam a várias das tecnologias da WEB.
...
protótipo foi utilizada uma estilização simples, que se pode parecer
natural na WEB; não obstante, nos dispositivos móveis o layout é
muito diferente da experiência normal.

Uma solução para este problema é utilizar frameworks como o Ionic
e Sencha Touch ou jQuery Mobile os quais possibilitam criar elementos
típicos de interfaces mobile como listas com scroll, botões e
transições com uma aparência nativa de forma relativamente fácil
\autocite{publishHtml5}.
