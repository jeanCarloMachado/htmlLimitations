...
Efeito similar a shaders em vídeo é atingido no Firefox através da importação 
de vídeo dentro de um contexto WebGL \footnote{O endereço \url{https://developer.Mozilla.org/en-US/docs/Web/API/WebGL_API/Tutorial/Animating_textures_in_WebGL} contém exemplos de como utilizar vídeos em um contexto WebGL}. Contudo, as diretivas de controle de vídeo 
em outros navegadores como o Chrome são diferentes, devido a inexistência de especificação.
...
esse controle é geralmente garantido, já na WEB não se permite esse controle. %pesquisar mais sobre isso
