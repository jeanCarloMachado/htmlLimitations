...
e jQuery Mobile podem ser encontradas nos apendice.}. Estes frameworks
...
Em termos gerais, trabalhar com tamanhos relativos em CSS é positivo.
Não obstante, há casos, como o dos botões de certo e errado, em que
a proporções ficam exageradas, nesses casos utilizar controles como o
\textit{max-width} e \textit{min-width} é uma solução conveniente.

Tecnologias experimentais em CSS geralmente levam o nome do distribuidor
como prefixo. Utilizar as mesmas regras em CSS com prefixos diferentes
é um processo entediante e propenso à duplicação e erros. A
biblioteca \textit{-prefix-free} é uma possível solução para este
problema, detectando automaticamente quando prefixos são necessários e
...
Este problema aconteceu durante o desenvolvimento do protótipo e
