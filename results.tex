...
shaders diretamente no vídeo \autocite[p. 8]{researchOnHtml} \limitation{noEffectsOnVideo}. Não
obstante, efeito similar a shaders em vídeo é atingido através da
importação de vídeo dentro de um contexto WebGL \footnote{O endereço
...
em um contexto WebGL}, ou utilizando o contexto 2D do canvas.
