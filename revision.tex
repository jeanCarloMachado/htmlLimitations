...
Atualmente a única forma de utilizar gamepads é usando-os emulados através de software 
de terceiros para se comportarem como mouses e teclados \autocite{gamepad}.

A API de Gamepad é uma especificação que define a interação de uma página WEB com Gamepads.
