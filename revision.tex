...
de filosofias e ideias as quais a web se baseia. Transparência,
...
\subsection{WEBVR}
%{{{
Segundo \cite{virtualReality} realidade virtual é uma experiência em que o
usuário é efetivamente imerso em um mundo virtual responsivo.
Realidade virtual é uma área nem tão nova mas que recebeu um novo interesse
recentemente. Fator que, pelo menos me parte, catalizou essa mudança é o advento
dos dispositivos móveis inteligentes. O hardware necessário para fornecer uma
experiência minimamente viável como acelerômetros, câmeras e telas de alta resolução está 
disponível em praticamente todos os dispositivos comercializados.

Realidade virtual é uma área de grande interessa para jogos, oferecer
uma experiência interativa com desafios e diversão aliados a um mundo
virtual que possibilita imersão quase total é de interessa de grande
parcela dos produtores de jogos.

A WebVR è uma especificação que pretende trazer os benefícios
