...
para armazenamento e decodificá-lo para ser consumido. 
Dados multimídia são enormes, sem serem codificados, um vídeo ou áudio
consistiriam em uma enorme quantidade de dados que seriam muito 
grandes para serem transmitidos pela internet em um período de tempo razoável \autocite{proHtml5}.
O objetivo dos
