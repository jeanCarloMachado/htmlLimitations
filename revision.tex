...
Com o DevTools também é possível emular dispositivos alvo da aplicação ou
...
dentro Google Chrome do computador e utilizar as já mencionadas
tecnologias do DevTools.

Existem ferramentas especializadas na depuração de tecnologias
quase exclusivas de jogos como inspetor do WebGL do Google Chrome.
Com o inspetor WebGl é possível conferir os estados dos buffers,
informações de texturas, frames individuais e outras informações
úteis \autocite{html5mostwanted}.
