...
principais: \textit{deviceorientation} e \textit{devicemotion}. O evento
\textit{deviceorientation} prove a orientação do dispositivo expressa
como uma série de rotações a partir de um frame de coordenadas locais
\autocite{orientationSpec}. Já o evento \textit{devicemotion} dispõe
de informações de movimento através de um sistema cartesiano e taxa
de movimento.
