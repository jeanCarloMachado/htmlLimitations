...
Os níveis inferiores representam as funcionalidades vitais do CSS, os níveis
superiores dependem dos inferiores para construir as funcionalidades mais elaboradas.
...
A primeira especificação do CSS, CSS1 (ou nível 1) foi lançada em 1996. Em 1997 foi lançado o
 ...
 do CSS3 que ainda continua em 2015. Além do nível 3 existem módulos de nível 4 no CSS,
 não obstante o termo CSS3 ainda é o mais utilizado.
...
]n]%\subsection{Transformações 3D}
...
de endereço. Não obstante, alguns recomendam soluções como a abaixo:
...
neste tipo de software. Para desabilitar a seleção pode-se utilizar o 
conteúdo abaixo.
