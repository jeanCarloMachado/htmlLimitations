...
Ideal para a criação de ambientes virtuais, jogos e simulações.
...
interface do WebGL é o canvas, no contexto 3D. Essa integração com o
DOM permite que o WebGL seja manipulado assim como os demais elementos
HTML.
