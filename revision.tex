...
Jogos da WEB contém vários aspectos positivos. Talvez o mais reconhecível
é o fato de com uma única base de código poder suprir uma gama praticamente
inesgotável de dispositivos. Comparável a base de clientes está a quantidade
de desenvolvedores WEB, os quais podem reaproveitar grande parcela do conhecimento
adquirido através do desenvolvimento de páginas WEB para criar jogos.
...
além do JavaScript gerem código que rode nativamente nos navegadores
com grande ganhos de performance e flexibilidade, visto que será
possível utilizar qualquer linguagem para gerar código especificado
pelo Web Assembly.
...
\section{NAVEGADORES}
%{{{
Navegadores são softwares, onde as tecnologias da OWP são
interpretadas e geram um conteúdo útil para os usuários.
Navegadores adotam a arquitetura cliente servidor. Sendo
o navegador o lado cliente e o servidor sendo o computador
que fornece código em HTML.
...
A mais importante destas bibliotecas que compõem os navegadores é o
motor de renderização, seguindo por um motor JavaScript.
