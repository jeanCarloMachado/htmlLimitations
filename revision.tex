...
intuitiva. \citet{crossPlatformMobileGame} cita que:
\begin{quote}
...
com cautela suas tecnologias. \citet{html5mostwanted} afirma que: o
...
as ferramentas da WEB. Segundo \cite[p. 28]{gwt} um bom exemplo
...
experiência possível \autocite[p. 7]{aSeriousContender}.
...
Segundo \cite[p. 23--24]{CascadingStyleSheets}:
\begin{quote}
...
%}}}
\subsection{WEBVR}
%{{{ Segundo \citet{virtualReality} realidade virtual é uma experiência em que o usuário é efetivamente imerso em um mundo virtual responsivo.
...
Abaixo segue uma lista de alguns codecs populares para áudio segundo \cite[p. 67]{proHtml5}.
