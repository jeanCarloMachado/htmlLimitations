...
são uma boa opção para desenvolver e depurar aplicações WEB em
J-avaScript.
...
\autocite{chromeDevTools}.

Também é possível emular os dispositivos alvo da aplicação.
...
\autocite{browserGamesTechnologyAndFuture} cita que: aplicativos
baseados na web, por não requererem instalação, sua distribuição é
...
O PhoneGap é uma tecnologia que permite encapsular um código em HTML e disponibilizá-lo
nativamente. Não obstante, para empacotar os aplicativos localmente é necessária configuração
substancial e só é possível empacotar para IOs em um computador da Apple. Alternativamente
o PhoneGap disponibiliza um serviço de empacotamento na nuvem que soluciona estes problemas
o PhoneGap Build.
