...
WebGL só se tornou uma possibilidade performática para jogos pois parte do seu processamento pode ser delegado para a GPU. Shaders são os elementos que são executados do lado da GPU.
