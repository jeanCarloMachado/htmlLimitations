...
São uma forma de adicionar animações em uma página web. Estas
animações são compostas por um estado inicial e um final. A
especificação de transições permite grande controle sobre seus
...
A transformação demonstrada na figura \ref{fig:CSSTransition} escala o
