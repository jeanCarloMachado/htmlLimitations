...
Existem ferramentas especializadas na depuração de Jogos como inspetor
do WebGL do Google Chrome. Com o inspetor WebGl é possível conferir
os estados dos buffers, informações de texturas, frames individuais e
outras informações úteis \autocite{html5mostwanted}.
