...
similar. Conquanto, o Math Workout não apresenta a resposta, sendo
...
muito lenta, geralmente não vê a tela. No final do carregamento de
todos os recursos é disparado o evento \textit{window.onload} neste
momento carrega-se a div da partida e dá-se início a mesma.
...
utilizar o \textit{window.requestAnimationFrame}. Esta função reduz
ou completamente para a execução do laço enquanto o usuário está
