...
explorar diversos recursos do HTML, e criar melhorias incrementais. 
Por não ser tão complexo de suportar em diversos tamanhos de telas e tipos
de entrada de dados diferentes. E, por fim, por oferecer uma dificuldade
técnica não tão desafiadora. Visto que não disponho de experiência
profunda no desenvolvimento de jogos HTML.
...
O jogo Countdown, também para a Android apresenta o valor final mas
pede para o usuário determinar a equação que resultou no valor dado.
Nosso protótipo também apresenta o valor final, mas juntamente com a
questão, não obstante este também é um exemplo de jogo similar.
