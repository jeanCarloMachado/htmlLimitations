...
telas são escondidas e a \textit{div} de carregamento de recursos é mostrada em
...
adicionou suporte a esta notação, inclusive o prefixo Apple, mas as
intenções é que o prefixo seja removido nas próximas versões. Para
os demais dispositivos não existe meio oficial de esconder a barra de
endereço. Não obstante, alguns sites recomendam a solução descrita
abaixo:
