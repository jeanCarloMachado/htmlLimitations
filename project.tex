...
requer a presença de um teclado numérico. Os botões de verdadeiro ou
falso contém todas as possibilidades de interação com a aplicação.
A figura \ref{fig:gameScreen} demonstra a interface contendo os botões
descritos.
