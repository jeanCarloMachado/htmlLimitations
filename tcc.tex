...
A impossibilidade de tradução via métodos convencionais, deve-se
...
aproximação possível. Essa limitação deu origem uma especificação
própria de como renderizar HTML.
...
seus conceitos, como o XHTML4.

A maioria das versões HTML de grande sucesso foram versões de
retrospectiva (\textit{"retro-specs"}), entrando em sincronia com o
mundo enquanto busca a direção correta \autocite{diveIntohtml}.
...
reside entre o abrir e fechar da tag \autocite{htmlAndCssDucket}.%pg24
