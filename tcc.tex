...
navegadores constantemente introduziam elementos de apresentação com o
blink, itálico, e bold, que eventualmente acabavam por serem inclusos
...
HTML como uma linguagem de conteúdo semântico, abrindo espaço para a
expansão de outras tecnologias como o CSS para responder as demandas de
apresentação.
