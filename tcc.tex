...
desafios e oportunidades. O HTML é uma ferramenta que possibilita a
construção de jogos para múltiplas plataformas; entretanto, as tecnologias
do HTML mudam constantemente e seu suporte é variado. Neste contexto,
este trabalho busca estudar as limitações do HTML quando aplicado
...
\\
\\
{\bfseries Palavras-chave:} Games, HTML, Limitations, Multiplatform
\end{abstract}
