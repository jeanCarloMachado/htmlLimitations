...
\textbf{Jogos nativos}: uma possibilidade é a criação de jogos nativos - um para cada plataforma. Esta estratégia contém os seguintes benefícios: 
...
\textbf{Jogos WEB}
Jogos WEB são aqueles que utilizam HTML5, JavaScript e CSS como tecnologias. Jogos WEB acarretam nos seguintes benefícios:
