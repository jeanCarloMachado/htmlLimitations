...
tecnologias da WEB e detecção de limitações.
...
As limitações serão elencadas através de experiência prática, 
através da concepção de um protótipo, e revisão bibliográfica.
Para tanto foram determinados alguns assuntos que serão abordados.
...
\cite{gamesIntroduction} contém uma lista de tecnologias relevantes ao
desenvolvimento de jogos na WEB.

A partir dos elementos citados, julgamos relevante estudar os seguintes
relacionadas aos jogos:

Com estas tecnologias elencadas
