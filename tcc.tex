...
cabe ao desenvolvedor detectar navegadores que não comportam as
necessidades tecnológicas e prover uma alternativa ou ao menos
notificar o usuário. Uma boa referência de recursos suportados pelos
navegadores é o site http://caniuse.com/. A biblioteca Modernizr é uma
boa ferramenta para detectar suporte a recursos HTML nos navegadores.
