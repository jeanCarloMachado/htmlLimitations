...
Este capítulo tem por objetivo detalhar os aspectos do desenvolvimento do
protótipo.  Mecânica, o loop de eventos, diagramas entre outras facetas do jogo serão abordados aqui.
...
pelo jogo está correto ou não. O tempo é um fator determinante no
resultado do jogo pois quão mais rápido o jogador acertar se a afirmação
está correta ou não mais pontos ele receberá.

Esta categoria de jogo foi selecionada pois oferece uma experiência
interessante, por ter profundidade - oferencendo a possibilidade
...
Não obstante, Math Workout não sugere respostas para o usuário
e o questiona sobre a veracidade delas, este apresenta apenas a equação
