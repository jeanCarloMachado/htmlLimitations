...
CSS (\textit{Cascading Style Sheets}) é uma linguagem de folhas de estilo, criada por Håkon Wium Lie em
1994, com intuito de definir a apresentação de páginas HTML.


O termo Cascading refere-se ao fato de regras serem herdadas pelos filhos de um elemento.

Antes do CSS o estilo das páginas era incluso dentro do HTML. Isso era
...
CSS é formado por um conjunto de regras, que por sua vez são compostas por seletores e
blocos de declaração. Os elementos selecionados são denominados o assunto do seletor \autocite{cssSelectors}.

Seletores tem o intuito de definir quais partes do documento HTML serão afetadas por
