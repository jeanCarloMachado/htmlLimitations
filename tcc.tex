...
\DeclareAcronym{MP3}{
short = {\normalfont MP3},
long  = - MPEG-1 or MPEG-2 Audio Layer III,
class = abbrev
}
\DeclareAcronym{HTTP}{
short = {\normalfont HTTP},
...
\DeclareAcronym{MDN}{
short = {\normalfont MDN},
long  = - Mozilla Developer Network,
class = abbrev
}
\DeclareAcronym{GPU}{
short = {\normalfont GPU},
...
\DeclareAcronym{OWP}{
short = {\normalfont OWP},
long  = - Open Web Platform,
class = abbrev
}
\DeclareAcronym{RWD}{
short = {\normalfont RWD},
long  = - Responsive web design,
class = abbrev
}
\DeclareAcronym{API}{
short = {\normalfont API},
...
{\listoftables}
\clearpage
\printacronyms[include-classes=abbrev,name={\hfill\normalfont\fontsize{14}{17}\bfseries LISTA DE ABREVIATURAS E SIGLAS\hfill}]
\clearpage
{\tableofcontents}
%\listoftables
%}}}k
